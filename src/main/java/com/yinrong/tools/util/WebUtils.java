...
public abstract class WebUtils {
	...
	private static final String DEFAULT_CHARSET = OpenConstants.CHARSET_UTF8;
	...
	public static String doPost(String url, Map<String, String> params, String charset, String accept, int connectTimeout, int readTimeout)
			throws IOException {
		String ctype = "application/x-www-form-urlencoded;charset=" + charset;
		String query = buildQuery(params, charset);
		byte[] content = {};
	 ...
	 * @throws IOException
	 */
	public static String doDelete(String url, String charset, int connectTimeout, int readTimeout) throws IOException {
		String ctype = "application/x-www-form-urlencoded;charset=" + charset;
	...
	public static String doPost(String url, String accept, String ctype, byte[] content, int connectTimeout, int readTimeout) throws IOException {
		HttpURLConnection conn = null;
		OutputStream out = null;
		String rsp = null;
		try {
	 ...
	 * @throws IOException
	 */
	public static String doPost(String url, Map<String, String> params, Map<String, FileItem> fileParams, int connectTimeout,
	...
	public static String doPost(String url, Map<String, String> params, Map<String, FileItem> fileParams, String charset,
		...
		if (StringUtils.isBlank(charset))
			charset = OpenConstants.CHARSET_UTF8;
		if (fileParams == null || fileParams.isEmpty()) {
